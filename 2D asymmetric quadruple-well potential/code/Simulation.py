...
class ToySimulation:
    ...
    def plot_trajs(self, trajs):
        ...
        cb = ax.contourf(x, y, V, levels=50, cmap=anh_cmap)
    ...
    def plot_trajs_animation(self, trajs):
        ...
        cb = ax.contourf(x, y, V, levels=50, cmap='coolwarm')
        ...
        ani = FuncAnimation(fig, update, frames=len(trajs[0]), interval=1000, repeat=False)
        ani.save(f"research_plots/test.gif", dpi=300, writer=PillowWriter(fps=25))
        print('hahaha')
