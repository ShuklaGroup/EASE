...
class LeastCounts:
    ...
    def generate_data(self, md_steps ,initial_coords,num_reps = 1,timestep = 1e-3, n_steps= 200, seed = None):
        ...
        self.model = dt.data.quadruple_well_asymmetric(h =timestep, n_steps =n_steps)
