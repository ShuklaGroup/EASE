...
class LeastCounts:
    ...
    def __init__(self, root_path, round_no,msm_path):
        self.root_path = root_path
        self.round_no = round_no
        self.policy_name = "LeastCounts"
        self.msm_path = msm_path

    def get_states(self,states, traj_list=None):
        ...
        all_trajs = np.concatenate(traj_list)
    ...
    def generate_data(self, mc_steps,start_states, num_reps, seed):
        ...
        for start_state, rep in zip(start_states, range(num_reps)):
...
class RandomSampling(LeastCounts):
    ...
    def __init__(self, root_path, round_no,msm_path):
        super().__init__(root_path, round_no,msm_path)
